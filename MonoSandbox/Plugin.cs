...
namespace MonoSandbox
{
    ...
    [BepInDependency("tonimacaroni.computerinterface", "1.5.3")]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        internal void FixedUpdate()
        {
            if (GorillaLocomotion.Player.Instance != null)
                Physics.Raycast(GorillaLocomotion.Player.Instance.rightControllerTransform.position, GorillaLocomotion.Player.Instance.rightControllerTransform.forward, out PluginInfo.raycastHit, GorillaLocomotion.Player.Instance.locomotionEnabledLayers);
